...
- Replace `Tetiana-Hishchak` with your Github username in the [DEMO LINK](https://Tetiana-Hishchak.github.io/react_dynamic-list-of-goods/) and add it to the PR description.

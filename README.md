...
- Implement a solution following the [React task guideline](https:/git checkout -b develop/github.com/mate-academy/react_task-guideline#react-tasks-guideline).

...
- Replace `Irina-Kulish` with your Github username in the [DEMO LINK](https://Irina-Kulish.github.io/react_dynamic-list-of-goods/) and add it to the PR description.

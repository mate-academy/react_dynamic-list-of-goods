...
- Replace `OlgaOchichenko` with your Github username in the [DEMO LINK](https://OlgaOchichenko.github.io/react_dynamic-list-of-goods/) and add it to the PR description.

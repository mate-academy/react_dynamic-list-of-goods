...
1. `Load red goods` should load all the goods and show only `red` ones;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Oleksii-Mishchenko.github.io/react_dynamic-list-of-goods/) and add it to the PR description.

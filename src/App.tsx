...
export const App: React.FC = () => {
  ...
  const handleLoadAllGoods = () => {
    getAll().then(recievedGoods => setGoods(recievedGoods));
  };

  const handleLoadFirstFiveGoods = () => {
    get5First().then(recievedGoods => setGoods(recievedGoods));
  };

  const handleLoadRedGoods = () => {
    getRedGoods().then(recievedGoods => setGoods(recievedGoods));
  };
